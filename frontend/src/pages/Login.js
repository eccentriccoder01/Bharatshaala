...
const Login = () => {
  ...
  const validatePassword = async (password) => {
    try {
      ...
      setPasswordError(t('passwordCheckError'));
  ...
  const sendOTPLogin = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setEmailError(t('otpSendProblem'));
      }
    } catch (error) {
      setEmailError(t('otpSendError'));
    }
    setIsLoading(false);
  };
  ...
  const verifyOTPLogin = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setPasswordError(t('wrongOtp'));
      }
    } catch (error) {
      setPasswordError(t('otpVerifyError'));
    }
    setIsLoading(false);
  };
  ...
  if (pageLoading) {
    return <LoadingSpinner message={t('wait')} />;
  }
        ...
        <div className="max-w-md mx-auto px-6 py-8">
          ...
          <div className="text-center mb-8">
            <div className='inline-flex items-center space-x-3 bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/30 dark:to-green-900/30 rounded-full px-6 py-3 mb-6 shadow-lg border border-emerald-200 dark:border-emerald-700'>
              ...
              <span className='text-emerald-800 dark:text-emerald-300 font-bold'>{t('welcomeBack')}</span>
            </div>
          ...
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-emerald-200 dark:border-gray-700">
            ...
            <div className="flex bg-emerald-100 dark:bg-emerald-900/30 rounded-xl p-1 mb-6">
              <button
                ...
                className={`flex-1 py-3 px-4 rounded-lg text-sm font-medium transition-all duration-200 ${loginMethod === 'email'
              ...
              <button
                ...
                className={`flex-1 py-3 px-4 rounded-lg text-sm font-medium transition-all duration-200 ${loginMethod === 'phone'
                  ? 'bg-emerald-500 text-white shadow-md'
                  : 'text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-gray-700'
                  }`}
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-4 pl-12 border-2 rounded-xl transition-all duration-300 ${emailError
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-4 pl-12 pr-12 border-2 rounded-xl transition-all duration-300 ${passwordError
                        ? 'border-red-300 focus:border-red-500'
                        : 'border-emerald-200 dark:border-gray-600 focus:border-emerald-500'
                        } focus:outline-none bg-white dark:bg-gray-700 dark:text-gray-100 text-lg`}
                ...
                {otpSent && (
                  <div className="mb-6">
                    ...
                    <p className="text-emerald-600 dark:text-emerald-400 text-sm mt-2">
                      {language === 'hi' ? `📱 ${phoneNumber} ${t('otpSentMsg')}` : `📱 ${t('otpSentMsg')} ${phoneNumber}`}
                    </p>
                  </div>
                )}
              </>
            ...
            {loginMethod === 'email' && (
              <div className="flex justify-between items-center mb-6">
                <label className="flex items-center space-x-2 cursor-pointer">
                  ...
                  />
                  <span className="text-emerald-700 dark:text-emerald-300 text-sm">{t('rememberMe')}</span>
                </label>
            ...
            <button
              onClick={login}
              disabled={isLoading}
              className={`w-full bg-gradient-to-r from-emerald-500 to-green-500 text-white py-4 rounded-xl font-semibold text-lg transition-all duration-300 ${isLoading
            ...
            >
              {isLoading ? (
                ...
                loginMethod === 'phone' && !otpSent ? t('sendOtpButton') : t('loginButton')
              )}
            </button>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-gray-800 text-emerald-600 dark:text-emerald-400 font-medium">{t('orLoginWith')}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  ...
                  <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
