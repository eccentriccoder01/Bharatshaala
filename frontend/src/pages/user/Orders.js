                    ...
                    {orderStatuses.map((status) => (
                      <button
                        ...
                        className={`flex items-center space-x-2 px-4 py-2 rounded-full transition-all duration-300 ${selectedStatus === status.id
                          ...
                          : `bg-${status.color}-100 dark:bg-gray-700 text-${status.color}-700 dark:text-${status.color}-300 hover:bg-${status.color}-200 dark:hover:bg-gray-600 border border-${status.color}-300 dark:border-${status.color}-700`
                          }`}
                      >
