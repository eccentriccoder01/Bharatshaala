              ...
              <div className="mb-8 p-6 bg-blue-50 rounded-2xl border border-blue-200">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none ${errors.upi ? 'border-red-300' : 'border-blue-200 focus:border-blue-500'
                      }`}
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      maxLength="19"
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none font-mono ${errors.number ? 'border-red-300' : 'border-purple-200 focus:border-purple-500'
                        }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="MM/YY"
                      maxLength="5"
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none font-mono ${errors.expiry ? 'border-red-300' : 'border-purple-200 focus:border-purple-500'
                        }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="123"
                      maxLength="4"
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none font-mono ${errors.cvv ? 'border-red-300' : 'border-purple-200 focus:border-purple-500'
                        }`}
                    />
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none ${errors.name ? 'border-red-300' : 'border-purple-200 focus:border-purple-500'
                        }`}
                    />
