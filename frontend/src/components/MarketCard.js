          ...
          <div className='md:w-2/3 p-6'>
            ...
            <div className='grid grid-cols-3 gap-4 mb-4'>
              <div className='text-center bg-emerald-50 rounded-lg p-3'>
                ...
                <div className='text-emerald-600 text-xs'>{t('vendors')}</div>
              </div>
              <div className='text-center bg-emerald-50 rounded-lg p-3'>
                <div className='text-lg font-bold text-emerald-600'>{market.reviews || 0}</div>
                <div className='text-emerald-600 text-xs'>{t('reviews')}</div>
              </div>
              <div className='text-center bg-emerald-50 rounded-lg p-3'>
                <div className='text-lg font-bold text-emerald-600'>{market.openingHours || 'N/A'}</div>
                <div className='text-emerald-600 text-xs'>{t('hours')}</div>
              </div>
            </div>
      ...
      <div className='p-6'>
        ...
        <div className='grid grid-cols-2 gap-4 mb-6'>
          ...
          <div className='text-center bg-emerald-50 rounded-lg p-3'>
            ...
            <div className='text-emerald-600 text-xs'>{t('priceRange')}</div>
          </div>
        </div>
